...
export default function RestaurantShowcase({ data }: RestaurantShowcaseProps) {
    ...
    <div className="py-20 max-mobile:py-16">
      <div className="container-lg2">
        <h2 className="heading2 text-primary text-center mb-[120px] mx-auto max-mobile:mb-[60px]">
          Our Successful Projects in <span className="text-gradient">Restaurant Management</span>
        </h2>
          ...
          <div className="absolute max-tab:relative max-tab:top-0 max-mobile:left-0 top-[-8%] left-0 max-w-[50%] max-tab:max-w-full h-[500px] max-tab:h-auto">
            <AnimatePresence mode="wait">
              <motion.img
                ...
                alt={data[activeSlide]?.projectName}
                className="w-full h-full object-contain max-tab:h-auto"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
          ...
          <div className="py-[60px] max-tab:p-0 px-10 max-w-[670px] ml-auto max-tab:max-w-full">
            <div className="">
              ...
              <div className="bg-[#DAE8FF] rounded-full p-2 flex items-center gap-2 w-fit ml-auto mt-2">
                <div className="text-white cursor-pointer custom-swiper-button-prev bg-gradient-to-b from-[#FF5E01] to-[#FF9404] transition-all ease-in-out duration-300 hover:text-white max-mobile:w-10 max-mobile:h-10 w-12 h-12 flex items-center justify-center rounded-full">
                  <ChevronLeft className="w-6 h-6 max-mobile:w-5 max-mobile:h-5" />
                </div>
                <div className="text-white cursor-pointer custom-swiper-button-next bg-gradient-to-b from-[#FF5E01] to-[#FF9404] transition-all ease-in-out duration-300 hover:text-white max-mobile:w-10 max-mobile:h-10 w-12 h-12 flex items-center justify-center rounded-full">
